      ...
      <main>
        ...
        <section id="management" className="py-16 md:py-20 bg-slate-50/50">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="mb-10 md:mb-12 text-center max-w-3xl mx-auto">
              <p className="text-[10px] font-bold text-[#6b8f7a] uppercase tracking-widest mb-3">Complete Oversight</p>
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-[#1f3d2b] mb-4">Easy Management Hub</h2>
              <p className="text-[#3d5f4d] text-base md:text-lg font-light leading-relaxed">
            ...
            <div className="overflow-x-auto pb-4 md:pb-0 -mx-4 md:mx-0 px-4 md:px-0 scrollbar-hide">
              <div className="app-window rounded-2xl bg-white ring-1 ring-slate-200 overflow-hidden min-w-[800px] md:min-w-0 max-w-5xl mx-auto border border-slate-200">
                ...
                <div className="bg-[#f3f3f3] border-b border-slate-200 h-10 flex items-center px-4 justify-between">
                  ...
                  <div className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">Salvia Workspace — Orchard Health Enterprise</div>
                ...
                <div className="flex h-[550px]">
                  ...
                  <div className="w-64 vsl-sidebar flex flex-col shrink-0 text-[12px] text-slate-600 border-r border-slate-100">
                    <div className="p-4 font-bold uppercase text-[9px] text-slate-400 tracking-wider">Explorer</div>
                  ...
                  <div className="flex-1 flex flex-col bg-white">
                    <div className="h-10 bg-[#ececec] border-b border-slate-200 flex text-[10px] font-medium items-center">
                      ...
                      <div className="px-6 h-full flex items-center gap-2 text-slate-400">
                    ...
                    <div className="p-8">
                      <div className="flex justify-between items-center mb-8">
                        <div>
                          ...
                          <p className="text-xs text-slate-400 mt-1">Showing all active clinicians in North Region</p>
                        </div>
                      ...
                      <table className="w-full text-left text-[13px]">
                        ...
                        <tbody className="text-slate-600">
                          <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                            <td className="py-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center font-bold text-[#1f3d2b] text-xs">ER</div>
                          ...
                          <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                            <td className="py-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center font-bold text-amber-700 text-xs">MV</div>
                          ...
                          <tr className="hover:bg-slate-50 transition-colors">
                            <td className="py-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center font-bold text-slate-400 text-xs">SJ</div>
                            ...
                            <td className="py-4"><span className="px-2.5 py-1 rounded-full bg-slate-100 text-slate-500 text-[10px] font-bold">OFF-SHIFT</span></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
        ...
        <section id="documentation" className="py-16 md:py-24 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="space-y-6 md:space-y-8 max-w-xl order-2 md:order-1">
              <div>
                <p className="text-[10px] font-bold text-[#6b8f7a] uppercase tracking-widest mb-3">Single Source of Truth</p>
                <h3 className="serif text-3xl md:text-4xl lg:text-5xl font-bold text-[#1f3d2b] leading-tight">Care Documentation</h3>
                <p className="text-[#3d5f4d] text-base md:text-lg mt-4 font-light leading-relaxed">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  ...
                  <div>
                    <h4 className="font-bold text-[#1f3d2b] text-sm">Timelined Legal Records</h4>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <div className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center shrink-0">
                    <Layers className="w-5 h-5 text-[#6b8f7a]" />
                  </div>
                  <div>
                    <h4 className="font-bold text-[#1f3d2b] text-sm">Structured Integrity</h4>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  ...
                  <div>
                    <h4 className="font-bold text-[#1f3d2b] text-sm">Instant Retrieval</h4>
              ...
              <div className="mobile-frame transform scale-90 md:scale-100 origin-center">
                ...
                <div className="h-full flex flex-col pt-8 bg-white">
                  <div className="px-5 py-5 flex items-center justify-between border-b bg-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[9px] text-slate-400 uppercase font-bold tracking-tight mt-0.5">Room 204 • Wing North</p>
                      </div>
                    </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50/50">
                    <button className="w-full py-2.5 bg-white border border-slate-200 rounded-xl text-[10px] font-bold text-slate-400 flex items-center justify-center gap-2 hover:bg-slate-50 transition-all">
                    ...
                    <div className="space-y-4 pb-6">
                      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-50 pb-2.5">
                          ...
                          <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Nutrition & Hydration</span>
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <div className="p-3 bg-slate-50 rounded-xl">
                            <p className="text-[8px] text-slate-400 font-bold uppercase">Breakfast</p>
                            <p className="text-[12px] font-bold text-slate-800 mt-0.5">75% Intake</p>
                          </div>
                          <div className="p-3 bg-slate-50 rounded-xl">
                            <p className="text-[8px] text-slate-400 font-bold uppercase">PO Hydration</p>
                      ...
                      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-50 pb-2.5">
                          ...
                          <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Clinical Vitals</span>
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <div className="p-3 bg-red-50 rounded-xl border border-red-100">
                            <p className="text-[8px] text-red-400 font-bold uppercase tracking-tighter">B-Sugar (AC)</p>
                            <p className="text-[12px] font-bold text-red-700 mt-0.5">142 mg/dL</p>
                          </div>
                          <div className="p-3 bg-slate-50 rounded-xl">
                            <p className="text-[8px] text-slate-400 font-bold uppercase tracking-tighter">Temp (Ax)</p>
                      ...
                      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-50 pb-2.5">
                          ...
                          <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Wellbeing & ADLs</span>
                        </div>
                        <div className="space-y-3">
                          <div className="flex justify-between items-center text-[11px] border-b border-slate-50 pb-2">
                            <span className="text-slate-500">ADL Support</span>
                            <span className="font-bold text-slate-800">Max Assist</span>
                          </div>
                          <div className="flex justify-between items-center text-[11px] border-b border-slate-50 pb-2">
                            <span className="text-slate-500">Mood/Affect</span>
                  ...
                  <div className="p-6 bg-white border-t border-slate-100 space-y-5">
                    <div className="flex flex-col items-center">
                      <div className="w-16 h-16 bg-[#1f3d2b] rounded-full flex items-center justify-center shadow-2xl audio-pulse relative cursor-pointer">
                        <Mic className="text-white w-8 h-8" />
                        <div className="absolute -inset-2 bg-emerald-500/10 rounded-full -z-10 animate-ping"></div>
                      </div>
                      <p className="text-[10px] font-bold text-[#1f3d2b] mt-4 animate-pulse uppercase tracking-[0.2em]">Live Assessment...</p>
                    </div>
        ...
        <section id="compliance" className="py-16 md:py-32 px-4 md:px-6 bg-[#f7f9f6]">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              <span className="text-[#6b8f7a] uppercase tracking-widest text-xs font-bold">Prevent Mistakes</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-[#1f3d2b] mt-4 mb-6">Error-Proof Compliance.</h2>
              <p className="text-base md:text-lg text-[#3d5f4d] font-light leading-relaxed mb-8">
            ...
            <div className="relative group mt-8 md:mt-0">
              ...
              <div className="relative bg-white p-6 md:p-10 rounded-[40px] shadow-xl border border-gray-100">
                <div className="flex items-center justify-between mb-10">
                  ...
                  <span className="px-3 py-1 bg-amber-50 text-amber-700 text-[10px] font-bold rounded-full">PENDING</span>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-amber-50 rounded-xl border border-dashed border-amber-300">
                    <div className="w-8 h-8 rounded bg-white border border-amber-300 flex items-center justify-center text-xs text-amber-500 shrink-0">03</div>
                    <div className="flex-1 text-sm font-medium text-amber-900">Awaiting Post-OP Tray Image Verify</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-8">
              <div className="max-w-2xl">
                ...
                <p className="text-[#3d5f4d] mt-4 text-base md:text-lg font-light leading-relaxed">Directly share customized feedback forms with specific patients post-visit or post-operation to catch issues early and continuously improve care quality.</p>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-[#f7f9f6] p-8 rounded-3xl shadow-sm border border-slate-100">
                <div className="text-[#6b8f7a] text-xs font-bold mb-4 uppercase tracking-widest">Share Easily</div>
              ...
              <div className="bg-[#f7f9f6] p-8 rounded-3xl shadow-sm border border-slate-100">
                <div className="text-[#6b8f7a] text-xs font-bold mb-4 uppercase tracking-widest">Targeted Surveys</div>
              ...
              <div className="bg-[#f7f9f6] p-8 rounded-3xl shadow-sm border border-slate-100">
                <div className="text-[#6b8f7a] text-xs font-bold mb-4 uppercase tracking-widest">Anomaly Alerts</div>
        ...
        <section id="problem" className="py-16 md:py-24 bg-white/50">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-xs font-bold leading-7 text-[#6b8f7a] uppercase tracking-widest">The Core Problem</h2>
                <p className="mt-2 font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-[#1f3d2b] leading-tight">
                  ...
                  <br /><span className="text-[#6b8f7a] italic">Clinical Burnout is Optional.</span>
                </p>
                <p className="mt-6 text-base md:text-lg text-[#3d5f4d] font-light leading-relaxed">Healthcare professionals spend up to 40% of their day on administrative data entry. This &quot;documentation debt&quot; leads to fatigue, errors, and less time for patients. Salvia resolves this by making documentation a natural byproduct of your care, not a separate chore.</p>
              </div>
              <div className="bg-white p-6 md:p-8 rounded-3xl shadow-xl border border-emerald-100">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-bold text-[#1f3d2b]">Before Salvia</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-[#1f3d2b]">After Salvia</h4>
        ...
        <section id="security" className="py-16 md:py-32 px-4 md:px-6 bg-[#f7f9f6]">
          <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
            <div className="md:col-span-1">
              <span className="text-[#6b8f7a] uppercase tracking-widest text-xs font-bold">Uncompromising</span>
            ...
            <div className="md:col-span-2 grid sm:grid-cols-2 gap-6 md:gap-8">
              <div className="p-6 md:p-8 border border-gray-100 rounded-2xl bg-white">
                <h4 className="font-bold text-[#1f3d2b] mb-2">End-to-End Encryption</h4>
              ...
              <div className="p-6 md:p-8 border border-gray-100 rounded-2xl bg-white">
                <h4 className="font-bold text-[#1f3d2b] mb-2">Zero-Knowledge Storage</h4>
              ...
              <div className="p-6 md:p-8 border border-gray-100 rounded-2xl bg-white">
                <h4 className="font-bold text-[#1f3d2b] mb-2">Audit Trails</h4>
              ...
              <div className="p-6 md:p-8 border border-gray-100 rounded-2xl bg-white">
                <h4 className="font-bold text-[#1f3d2b] mb-2">PII Masking</h4>
        ...
        <section id="blog" className="py-16 md:py-24 bg-white border-t border-slate-100">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
              ...
              <Link href="/blog" className="text-[#6b8f7a] font-bold text-sm hover:text-[#1f3d2b] transition-colors flex items-center gap-1">View all articles <ArrowRight className="w-4 h-4" /></Link>
            </div>
              ...
              {latestPosts.map((post) => {
                ...
                return (
                  <Link href={`/blog/${post.slug}`} key={post.slug} className="group block">
                    ...
                    <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#6b8f7a] mb-2">
                      <span>{post.category}</span> • <span>{post.readTime || "5 Min Read"}</span>
                    </div>
                    <h4 className={`font-serif font-bold text-xl text-[#1f3d2b] ${colors.textHover} transition-colors line-clamp-2`}>
                      {post.title}
                    </h4>
                  </Link>
                );
        ...
        <section id="opensource" className="py-20 md:py-32 bg-[#1f3d2b] relative overflow-hidden">
          ...
          <div className="mx-auto max-w-4xl px-4 md:px-6 relative z-10 text-center">
            <span className="text-[#6b8f7a] uppercase tracking-widest text-xs font-bold bg-[#6b8f7a]/10 px-3 py-1 rounded-full border border-[#6b8f7a]/20">100% Free & Open Source</span>

            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-8 mb-6">Your data. Your servers. Your control.</h2>
