...
export default function Hero3DScene() {
    return (
        <div className="w-full h-[600px] lg:h-full relative">
            ...
            {/* Overlay gradient to help blend with the page edge if needed */}
            <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_0%,rgba(255,255,255,0)_100%)]"></div>
        </div>
    );
}
