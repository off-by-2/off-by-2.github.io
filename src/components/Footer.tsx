    ...
    return (
        <footer className="relative bg-[#1f3d2b] text-white pt-16 md:pt-24 pb-12 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-12 gap-12 mb-20">
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="max-w-sm">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-[#6b8f7a] mb-3 block">Stay
                                Updated</label>
                    ...
                    <div className="lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-8">
                        <div>
                            <h5 className="font-bold text-xs uppercase tracking-[0.2em] text-[#6b8f7a] mb-6">Platform</h5>
                            <ul className="space-y-4 text-sm text-emerald-100/60 font-medium">
                        ...
                        <div>
                            <h5 className="font-bold text-xs uppercase tracking-[0.2em] text-[#6b8f7a] mb-6">Company</h5>
                            <ul className="space-y-4 text-sm text-emerald-100/60 font-medium">
                        ...
                        <div>
                            <h5 className="font-bold text-xs uppercase tracking-[0.2em] text-[#6b8f7a] mb-6">Resources</h5>
                            <ul className="space-y-4 text-sm text-emerald-100/60 font-medium">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase tracking-widest text-emerald-100/30 font-bold">
                    <div className="flex items-center gap-2">
                        <span>© 2026 OFF BY 2.</span><span className="w-1 h-1 rounded-full bg-[#6b8f7a]/50"></span><span>All rights reserved.</span>
                    </div>
